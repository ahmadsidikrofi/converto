...
export default function HeroSection() {
    ...
    return (
        <section className="relative w-full min-h-[90vh] flex flex-col items-center justify-center pt-20 pb-32 overflow-x-clip">
            {/* Morphing Background */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] sm:w-[800px] sm:h-[700px] opacity-15 dark:opacity-20 pointer-events-none blur-3xl">
